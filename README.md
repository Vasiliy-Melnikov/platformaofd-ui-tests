...
- [Примеры автоматизированных тест-кейсов](#tests)
- [Сборка в Jenkins](#jenkins)
- [Запуск из терминала](#run)
- [Allure отчёт](#allure)
- [Уведомления в Telegram](#telegram)
- [Видео выполнения тестов в Selenoid](#video)
...
### *Тест-кейсы*
![Allure suites](images/Alluresuites.jpg)
...
![Allure Telegram bot](images/Telegrambot.jpg)
